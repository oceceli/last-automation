                    ...
                    @if ($workOrder->isCompleted())
                        <tr class="positive">
                            ...
                            <td class="collapsing selectable">
                                ...
                                <span data-tooltip="{{ __('common.see_details') }}" data-variation="mini" data-position="top right">
                                    <i class="link primary eye icon"></i>
                                </span>
                            </td>
                        </tr>
                    @else
                        <tr class="@if(!$workOrder->inProgress()) teal @elseif($workOrder->is_active) warning @else error @endif">
